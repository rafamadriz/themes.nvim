local c = require("forest.colors")
local utils = require("forest.utils")
local cfg = require("forest.config").styles
local forest = {}
...
local function set_groups()
    local groups = {
        ...
        TSParameter = {fg = c.gray2}, -- For parameters of a function.
