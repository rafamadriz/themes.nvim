local c = require("onepro.colors")
local utils = require("onepro.utils")
local cfg = require("onepro.config").styles
local onepro = {}
...
local function set_groups()
    local groups = {
        ...
        EndOfBuffer = {fg = c.gray}, -- ~ lines at the end of a buffer
        NormalFloat = {fg = c.fg, bg = c.bg1}, -- normal text and background color for floating windows
        FloatBorder = {fg = c.blue, bg = c.bg1},
        ...
        PmenuSel = {fg = c.bg1, bg = c.blue, style = "bold"},
        PmenuSbar = {fg = c.fg, bg = c.bg1},
        PmenuThumb = {fg = c.fg, bg = c.fg},
        Question = {fg = c.green, style = cfg.bold},
        QuickFixLine = {fg = c.purple, bg = c.bg1, style = "bold,italic"},
        ...
        CursorColumn = {fg = c.none, bg = c.cursor},
        CursorLine = {fg = c.none, bg = c.cursor},
        ...
        Comment = {fg = c.gray_alt, bg = c.none, style = cfg.italic_comment},
        Conditional = {fg = c.purple, bg = c.none, style = cfg.italic_keyword}, -- italic if, then, else, endif, switch, etc.
        ...
        TSComment = {fg = c.gray_alt, bg = c.none, style = cfg.italic_comment}, -- For comment blocks.
        TSConditional = {fg = c.purple, style = cfg.italic_keyword}, -- For keywords related to conditionnals.
        ...
        TSKeywordFunction = {fg = c.purple, style = cfg.italic_keyword}, -- For keywords used to define a fuction.
        ...
        TSVariableBuiltin = {fg = c.blue, style = cfg.italic_variable}, -- Variable names that are defined by the languages, like `this` or `self`.        TSConstBuiltin = {fg = orange}, -- For constant that are built in the language: `nil` in Lua.
        ...
        NvimTreeNormal = {fg = c.blue, bg = bg0},
    ...
    local overrides = vim.g.onepro_overrides
    if overrides then
