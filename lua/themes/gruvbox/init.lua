local c = require("themes.gruvbox.colors")
...
local function set_groups()
	local groups = {
		...
		CursorLineNr = { fg = c.green, style = "bold" }, -- Like LineNr when 'cursorline' or 'relativenumber' is set for the cursor line.
		MatchParen = { fg = c.bg_dark, bg = c.aqua, style = "bold" }, -- The character under the cursor or just before it, if it is a paired bracket, and its match. |pi_paren.txt|
		...
		Pmenu = { bg = c.pmenu, fg = c.fg }, -- Popup menu: normal item.
		PmenuSel = { bg = c.yellow, fg = c.bg, style = "bold" }, -- Popup menu: selected item.
		...
		TabLineSel = { fg = c.bg_dark, bg = c.gray, style = "bold" }, -- tab pages line, active tab page label
		...
		TSNote = { fg = c.info, bg = c.none },
		TSWarning = { fg = c.warning, bg = c.none },
		...
		NeogitDiffContextHighlight = { bg = utils.darken(c.fg_gutter, 0.4), fg = c.none },
		NeogitDiffDeleteHighlight = { fg = c.fg, bg = c.diff_delete },
		NeogitDiffAddHighlight = { fg = c.fg, bg = c.diff_add },
		-- GitGutter
		...
		TelescopeSelection = { fg = c.aqua, bg = c.none },
		TelescopeSelectionCaret = { fg = c.aqua, bg = c.none },
		TelescopeMatching = { fg = c.magenta },
		-- NvimTree
		NvimTreeNormal = { fg = c.fg, bg = c.bg_sidebar },
		NvimTreeRootFolder = { fg = c.aqua, style = "bold" },
