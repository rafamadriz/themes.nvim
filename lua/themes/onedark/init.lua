...
local function set_groups()
	local groups = {
		...
		MatchParen = { fg = c.orange, bg = c.gray_fg, style = "bold" }, -- The character under the cursor or just before it, if it is a paired bracket, and its match. |pi_paren.txt|
		...
		PmenuSel = { bg = c.gray_fg, fg = c.fg, style = "bold" }, -- Popup menu: selected item.
		...
		TSTagAttribute = { fg = c.orange }, -- Tags like html tag names.
		TSTagDelimiter = { fg = c.gray_fg2 }, -- Tag delimiter like `<` `>` `/`
