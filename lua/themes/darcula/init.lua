local c = require("themes.darcula.colors")
...
local function set_groups()
	local groups = {
		...
		Folded = { fg = c.foldedFg, bg = c.foldedBg }, -- line used for closed folds
		...
		MatchParen = { fg = c.matchBraceFg, bg = c.matchBraceBg, style = "bold" }, -- The character under the cursor or just before it, if it is a paired bracket, and its match. |pi_paren.txt|
		...
		PmenuSel = { bg = c.menuSel }, -- Popup menu: selected item.
		...
		TSParameter = { fg = c.functionParam }, -- For parameters of a function.
		...
		TelescopeSelectionCaret = { fg = c.green, bg = c.none },
